...
/*ADDING WIKIPEDIA LINKS UNDER ASTRONAUT NAME
  //Step 1. Instead of span create an 'a' element
  //Step 2. Get Wikipedia links from this link: https://en.wikipedia.org/wiki/
        //1. Replace spaces with _: replace()
        //2. Append the new name to the wikipedia link
        //3. Set 'a' attribute href to this wikipedia link

  //Another way: to use wikipedia search api and write another fetch function: https://en.wikipedia.org/w/api.php?action=opensearch&format=json&search=
 */
