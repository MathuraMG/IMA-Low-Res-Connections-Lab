window.addEventListener('load', function () {
    ...
    fetch('/data')
        ...
        .then(data => {
            ...
            let curName = quotes[randomNum].name;
            document.getElementById("random-quote").innerText = '"' + randomQuote + '" - ' + curName;
        });
    ...
    quoteButton.addEventListener('click', function () {
        ...
        fetch("/quoteSave", {
            ...
            .then(data => {
                ...
                document.getElementById("random-quote").innerText = '"' + quote + '" - ' + name;
