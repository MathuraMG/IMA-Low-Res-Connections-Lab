...
window.addEventListener("load", () => {
    ...
    .then( data => { 
      let key = "page" +pageNo;
      document.getElementById("story-text").innerHTML = data[key].text;
      document.getElementById("story-img").src = data[key].image;
      pageNo++;
      storyData=data;
    })
    ...
    document.body.addEventListener("click", () => {
      let key = "page" +pageNo;
      document.getElementById("story-text").innerHTML = storyData[key].text;
      document.getElementById("story-img").src = storyData[key].image;
      pageNo++;
    })
  }
)
